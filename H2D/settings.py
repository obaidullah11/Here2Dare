"""
Django settings for Here2Dare project.
...
# print("path",BASE_DIR)
# FIREBASE_CREDENTIALS_PATH = os.path.join(BASE_DIR, 'Here2Dare', 'firebase.json')
...
# service_account_json = os.path.join(BASE_DIR, 'Here2Dare', 'adminsdk.json')
# try:
...
#     "site_title": "Here2Dare Administration",
#     "site_header": "Here2Dare",
...
JAZZMIN_SETTINGS = {
    ...
    "dashboard": {
        "widgets": [
            # First card widget for total users
            {
                "type": "count",  # Count widget type
                "model": "auth.User",  # The model you want to count
                "title": "Total Users",  # Widget title
                "icon": "fas fa-users",  # FontAwesome icon (optional)
                "url": "admin:auth_user_changelist",  # URL link to changelist (optional)
                "classes": "bg-primary text-white",  # Custom classes for styling (optional)
            },

            # Second card widget for total groups
            {
                "type": "count",  # Count widget type
                "model": "auth.Group",  # The model you want to count
                "title": "Total Groups",  # Widget title
                "icon": "fas fa-users-cog",  # FontAwesome icon (optional)
                "url": "admin:auth_group_changelist",  # URL link to changelist (optional)
                "classes": "bg-info text-white",  # Custom classes for styling (optional)
            },

            # Custom card with extra content
            {
                "type": "custom",  # Custom content widget type
                "title": "Quick Stats",  # Title of the card
                "content": """
                    <ul>
                ...
                """,  # You can use raw HTML or format dynamically
                "icon": "fas fa-chart-line",  # Icon for the card (optional)
                "classes": "bg-warning text-white",  # Custom styling (optional)
            },
        ]
    }
}
